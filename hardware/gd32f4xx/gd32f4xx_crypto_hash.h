/**
 * @file gd32f4xx_crypto_hash.h
 * @brief GD32F4 hash hardware accelerator
 *
 * @section License
 *
...
#ifndef _GD32F4XX_CRYPTO_HASH_H
#define _GD32F4XX_CRYPTO_HASH_H

//Dependencies
#include "core/crypto.h"

//Hash hardware accelerator
#ifndef GD32F4XX_CRYPTO_HASH_SUPPORT
   #define GD32F4XX_CRYPTO_HASH_SUPPORT DISABLED
#elif (GD32F4XX_CRYPTO_HASH_SUPPORT != ENABLED && GD32F4XX_CRYPTO_HASH_SUPPORT != DISABLED)
   #error GD32F4XX_CRYPTO_HASH_SUPPORT parameter is not valid
#endif
