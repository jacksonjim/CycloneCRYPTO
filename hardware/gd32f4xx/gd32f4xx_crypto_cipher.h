/**
 * @file gd32f4xx_crypto_cipher.h
 * @brief GD32F4 cipher hardware accelerator
 *
 * @section License
 *
...
#ifndef _GD32F4XX_CRYPTO_CIPHER_H
#define _GD32F4XX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef GD32F4XX_CRYPTO_CIPHER_SUPPORT
   #define GD32F4XX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (GD32F4XX_CRYPTO_CIPHER_SUPPORT != ENABLED && GD32F4XX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error GD32F4XX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
